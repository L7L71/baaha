...
async def bg():
    bot.loop.NTMxMTIzMDMyNjk0MDYzMTA0.DxJhHA.YyPRRiiui2Eupuq9VwCkWd_lOME(set_player_status())

@bot.event
async def on_ready():
    bot.loop.NTMxMTIzMDMyNjk0MDYzMTA0.DxJhHA.YyPRRiiui2Eupuq9VwCkWd_lOME(bg())
    print(bot.user.name)
